...
public class UpdateFinalizarRequest implements Serializable {
    @SerializedName("id")
    @Expose
    Integer id;
    ...
    public UpdateFinalizarRequest() {
    }

    public UpdateFinalizarRequest(Integer id, boolean usuario_principal_acepto, boolean usuario_ofertante_acepto) {
        this.id = id;
