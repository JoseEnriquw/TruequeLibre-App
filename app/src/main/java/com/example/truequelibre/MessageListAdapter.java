...
import com.example.truequelibre.Entity.Messages.UserMessage;
import com.example.truequelibre.Entity.Usuario;
import com.example.truequelibre.Utils.LongToDate;
...
public class MessageListAdapter extends RecyclerView.Adapter {
    ...
    public int getItemViewType(int position) {
        ...
        if (message.getUser().getId().equals(usuario.getId())) {
    ...
    private class SentMessageHolder extends RecyclerView.ViewHolder {
        ...
        void bind(UserMessage message) {
            ...
            timeText.setText(LongToDate.convertToString(message.getCreatedAt()));
        }
    }
    ...
    private class ReceivedMessageHolder extends RecyclerView.ViewHolder {
        ...
        void bind(UserMessage message) {
            ...
            // Format the stored timestamp into a readable String using method.
            timeText.setText(LongToDate.convertToString(message.getCreatedAt()));
            nameText.setText(message.getUser().getNombreApellido());
